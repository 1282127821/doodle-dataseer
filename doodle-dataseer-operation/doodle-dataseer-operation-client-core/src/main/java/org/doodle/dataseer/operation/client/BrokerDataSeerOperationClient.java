...
import org.doodle.design.dataseer.DataSeerOperationLogPageOps;
import org.doodle.design.dataseer.DataSeerOperationLogPageReply;
import org.doodle.design.dataseer.DataSeerOperationLogPageRequest;
import org.springframework.messaging.rsocket.RSocketRequester;
import reactor.core.publisher.Mono;

@FieldDefaults(level = AccessLevel.PRIVATE, makeFinal = true)
@RequiredArgsConstructor
public class BrokerDataSeerOperationClient implements DataSeerOperationClientRSocket {
  BrokerClientRSocketRequester requester;
  BrokerFrame frame;

  public BrokerDataSeerOperationClient(
  ...
  @Override
  public Mono<DataSeerOperationLogPageReply> page(DataSeerOperationLogPageRequest request) {
    return route(DataSeerOperationLogPageOps.RSocket.PAGE_MAPPING)
        .data(request)
        .retrieveMono(DataSeerOperationLogPageReply.class);
  }
